document.addEventListener('DOMContentLoaded', () => {
    ...
    const renderGrid = () => {
            ...
            companies.forEach(comp => {
                ...
                const cardHtml = `
                    <div class="company-card ${comp.id}">
                        ...
                        <div class="yield-box" style="padding: 1rem; margin-top: 1.5rem; border-radius: 12px; background: #f8fafc; overflow-x: auto;">
        ...
        const generateTableHtml = (withdrawalPlan, title) => {
            ...
            return `
                <div class="yield-box" style="padding: 1.5rem 1rem; border-radius: 12px; background: #f8fafc; display: flex; flex-direction: column; overflow-x: auto;">
